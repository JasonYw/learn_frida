...
public final class AudioTalkGuestViewHolder$bindView$$inlined$let$lambda$3 extends Lambda implements Function1<View, Unit> {
    ...
    public AudioTalkGuestViewHolder$bindView$$inlined$let$lambda$3(C5078b c5078b, LinkPlayerInfo linkPlayerInfo) {
        super(1);
        this.this$0 = c5078b;
    ...
    public final /* synthetic */ Unit invoke(View view) {
        if (!PatchProxy.proxy(new Object[]{view}, this, changeQuickRedirect, false, 1).isSupported) {
            C106862S5w.LIZ(view);
            if (!this.$linkPlayerInfo$inlined.LJJJJLL) {
                this.$linkPlayerInfo$inlined.LJJJJLL = true;
