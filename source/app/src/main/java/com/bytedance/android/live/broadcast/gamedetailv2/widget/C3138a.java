...
/* renamed from: com.bytedance.android.live.broadcast.gamedetailv2.widget.a */
/* loaded from: classes5.dex */
public final class C3138a implements AbstractC3125c {
    public static ChangeQuickRedirect LIZ;
    public final String LIZIZ;
    public final long LIZJ;
    public final C3243u LIZLLL;

    /* renamed from: LJ */
    public final List<C2985a> f25901LJ;
    ...
    private Object[] LIZJ() {
        ...
        return proxy.isSupported ? (Object[]) proxy.result : new Object[]{this.LIZIZ, Long.valueOf(this.LIZJ), this.LIZLLL, this.f25901LJ};
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof C3138a) {
            return C106862S5w.LIZ(((C3138a) obj).LIZJ(), LIZJ());
        }
        return false;
    }
    ...
    public final String toString() {
        ...
        return proxy.isSupported ? (String) proxy.result : C106862S5w.LIZ("GameDetailCommentProps:%s,%s,%s,%s", LIZJ());
    }
    ...
    public C3138a(String str, long j, C3243u c3243u, List<C2985a> list) {
