...
public final class GameIntroductionAndCountDownHelper$show$6 extends Lambda implements Function1<List<? extends w$a>, Unit> {
    ...
    public GameIntroductionAndCountDownHelper$show$6(C87146KVo c87146KVo) {
        super(1);
