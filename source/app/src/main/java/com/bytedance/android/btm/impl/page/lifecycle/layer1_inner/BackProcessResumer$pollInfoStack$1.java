...
public final class BackProcessResumer$pollInfoStack$1 extends Lambda implements Function0<Object> {
    ...
    public BackProcessResumer$pollInfoStack$1(Exception exc) {
        super(0);
        this.$ex = exc;
    }
