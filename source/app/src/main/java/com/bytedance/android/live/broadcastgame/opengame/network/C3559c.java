...
/* renamed from: com.bytedance.android.live.broadcastgame.opengame.network.c */
/* loaded from: classes5.dex */
public final class C3559c implements C3LJ {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof C3559c) {
            return C106862S5w.LIZ(((C3559c) obj).LIZ(), LIZ());
        }
        return false;
    }
    ...
    public final String toString() {
        ...
        return proxy.isSupported ? (String) proxy.result : C106862S5w.LIZ("CardFromPathInfoRsp:%s", LIZ());
    }
