...
public final class VoiceChatRoomAnchorView$playSeatPoopAnim$1 extends Lambda implements Function0<Unit> {
    ...
    public VoiceChatRoomAnchorView$playSeatPoopAnim$1(VoiceChatRoomAnchorView voiceChatRoomAnchorView) {
        super(0);
