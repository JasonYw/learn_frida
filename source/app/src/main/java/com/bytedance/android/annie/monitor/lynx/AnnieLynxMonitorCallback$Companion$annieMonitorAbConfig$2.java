...
public final class AnnieLynxMonitorCallback$Companion$annieMonitorAbConfig$2 extends Lambda implements Function0<Map<String, String>> {
    public static final AnnieLynxMonitorCallback$Companion$annieMonitorAbConfig$2 INSTANCE = new AnnieLynxMonitorCallback$Companion$annieMonitorAbConfig$2();
    ...
    public AnnieLynxMonitorCallback$Companion$annieMonitorAbConfig$2() {
        super(0);
    }
