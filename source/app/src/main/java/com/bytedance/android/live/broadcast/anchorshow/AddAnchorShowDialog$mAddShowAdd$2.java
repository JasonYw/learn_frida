...
public final class AddAnchorShowDialog$mAddShowAdd$2 extends Lambda implements Function0<TextView> {
    ...
    public AddAnchorShowDialog$mAddShowAdd$2(C89433LLn c89433LLn) {
        super(0);
    ...
    public final /* synthetic */ TextView mo30099invoke() {
        ...
        if (view != null) {
            return view.findViewById(2131166124);
        }
        return null;
    }
}
