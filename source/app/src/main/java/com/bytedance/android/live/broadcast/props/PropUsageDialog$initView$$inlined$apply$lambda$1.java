...
public final class PropUsageDialog$initView$$inlined$apply$lambda$1 extends Lambda implements Function0<Unit> {
    ...
    public PropUsageDialog$initView$$inlined$apply$lambda$1(LCV lcv) {
        super(0);
        this.this$0 = lcv;
    }
