...
public final class VideoTalkBeInvitedDialog$onViewCreated$7 extends Lambda implements Function1<View, Unit> {
    ...
    public VideoTalkBeInvitedDialog$onViewCreated$7(C78964HAw c78964HAw) {
        super(1);
    ...
    public final /* synthetic */ Unit invoke(View view) {
        ...
        if (!PatchProxy.proxy(new Object[]{view}, this, changeQuickRedirect, false, 1).isSupported) {
            ...
            if (room != null && (c8854es = this.this$0.LJFF) != null && (str = c8854es.LJJIFFI) != null) {
                ...
                if (LIZ != null) {
                    LIZ.LIZ(room.getId(), str, ReplyType.Agree.ordinal(), 2);
                }
                this.this$0.dismiss();
            }
        }
