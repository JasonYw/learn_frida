...
public final class AudienceTitleReverseBtnConfig implements AbstractC450853sN {
    ...
    public AudienceTitleReverseBtnConfig(State state) {
    ...
    public final String LIZ(Context context) {
        ...
        C106862S5w.LIZ(context);
        int i = LBL.LIZ[this.LIZIZ.ordinal()];
        if (i != 1) {
            if (i == 2) {
                return "已预约";
            }
    ...
    public final Drawable LIZIZ(Context context) {
        ...
        C106862S5w.LIZ(context);
        int i2 = LBL.LIZIZ[this.LIZIZ.ordinal()];
        if (i2 != 1) {
            if (i2 == 2) {
                i = 2130852746;
            } else {
    ...
    public final int LIZJ(Context context) {
        ...
        C106862S5w.LIZ(context);
        int i2 = LBL.LIZJ[this.LIZIZ.ordinal()];
        if (i2 != 1) {
            if (i2 == 2) {
                i = 2131624626;
            } else {
