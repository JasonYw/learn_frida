...
public final class OpenPanel$show$$inlined$let$lambda$1 extends Lambda implements Function0<Unit> {
    ...
    public OpenPanel$show$$inlined$let$lambda$1(WindowManager.LayoutParams layoutParams, DialogC3611f dialogC3611f) {
        super(0);
