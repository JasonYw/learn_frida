...
public final class DownloaderListener$onSuccessed$1 extends Lambda implements Function1<AbsDownloadListener, Unit> {
    ...
    public DownloaderListener$onSuccessed$1(DownloadInfo downloadInfo) {
        super(1);
    ...
    public final /* synthetic */ Unit invoke(AbsDownloadListener absDownloadListener) {
        ...
        if (!PatchProxy.proxy(new Object[]{absDownloadListener2}, this, changeQuickRedirect, false, 1).isSupported) {
            ...
            absDownloadListener2.onSuccessed(this.$entity);
        }
