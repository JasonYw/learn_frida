...
public final class ScreenshotsAuditService$appId$2 extends Lambda implements Function0<String> {
    ...
    public ScreenshotsAuditService$appId$2(ScreenshotsAuditService screenshotsAuditService) {
        super(0);
