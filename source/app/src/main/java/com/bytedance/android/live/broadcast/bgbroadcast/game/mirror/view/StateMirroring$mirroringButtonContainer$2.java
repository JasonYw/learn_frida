...
public final class StateMirroring$mirroringButtonContainer$2 extends Lambda implements Function0<LinearLayout> {
    ...
    public StateMirroring$mirroringButtonContainer$2(KDZ kdz) {
        super(0);
        this.this$0 = kdz;
    }
    ...
    /* renamed from: invoke */
    public final /* synthetic */ LinearLayout mo30099invoke() {
        PatchProxyResult proxy = PatchProxy.proxy(new Object[0], this, changeQuickRedirect, false, 1);
        if (proxy.isSupported) {
            return proxy.result;
        }
        return this.this$0.LIZJ.findViewById(2131183206);
    }
}
