...
public final class PromoteListAdapter$onBindViewHolder$4 extends Lambda implements Function1<String, Unit> {
    ...
    public PromoteListAdapter$onBindViewHolder$4(L9Y l9y, Function1 function1) {
        super(1);
        this.this$0 = l9y;
