...
public final class XRegisterBtmPageMethod extends XCoreBridgeMethod implements StatefulMethod {
    public static ChangeQuickRedirect changeQuickRedirect;
    public final String name = "x.registerBtmPage";
    ...
    public final void handle(XReadableMap xReadableMap, XBridgeMethod.Callback callback, XBridgePlatformType xBridgePlatformType) {
        ...
        RegisterBtmPageBridgeHelper.INSTANCE.handle(this, xReadableMap, callback, xBridgePlatformType);
    }
}
