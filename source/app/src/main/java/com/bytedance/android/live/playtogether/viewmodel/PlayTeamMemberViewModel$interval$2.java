...
public final class PlayTeamMemberViewModel$interval$2 extends Lambda implements Function0<MutableLiveData<Long>> {
    public static final PlayTeamMemberViewModel$interval$2 INSTANCE = new PlayTeamMemberViewModel$interval$2();
    ...
    public PlayTeamMemberViewModel$interval$2() {
        super(0);
    }
