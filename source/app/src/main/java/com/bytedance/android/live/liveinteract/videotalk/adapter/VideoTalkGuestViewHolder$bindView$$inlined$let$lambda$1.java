...
public final class VideoTalkGuestViewHolder$bindView$$inlined$let$lambda$1 extends Lambda implements Function1<View, Unit> {
    ...
    public VideoTalkGuestViewHolder$bindView$$inlined$let$lambda$1(User user, C4846aa c4846aa, LinkPlayerInfo linkPlayerInfo) {
        super(1);
        this.$it = user;
        this.this$0 = c4846aa;
    ...
    public final /* synthetic */ Unit invoke(View view) {
        if (!PatchProxy.proxy(new Object[]{view}, this, changeQuickRedirect, false, 1).isSupported) {
            C106862S5w.LIZ(view);
            if (this.this$0.LJJIFFI == 0 && this.$linkPlayerInfo$inlined.LJJJIL) {
                ALogger.m15797i("ttlive_video_talk_guest_view_holder", "click on the anonymous user avatar for apply , do not pull up the profile card");
