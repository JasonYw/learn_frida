...
public final class MiniGameToolbarBehavior$runAnimation$3 extends Lambda implements Function0<Unit> {
    ...
    public MiniGameToolbarBehavior$runAnimation$3(Ref.ObjectRef objectRef) {
        super(0);
