...
public class LynxRefreshFooter$$MethodInvoker implements LynxUIMethodInvoker<LynxRefreshFooter> {
    ...
    public void invoke(LynxRefreshFooter lynxRefreshFooter, String str, ReadableMap readableMap, Callback callback) {
        if (PatchProxy.proxy(new Object[]{lynxRefreshFooter, str, readableMap, callback}, this, changeQuickRedirect, false, 1).isSupported) {
            return;
        }
        try {
            switch (str.hashCode()) {
