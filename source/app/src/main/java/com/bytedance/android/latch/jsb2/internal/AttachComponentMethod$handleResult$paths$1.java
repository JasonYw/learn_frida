...
public final class AttachComponentMethod$handleResult$paths$1 extends Lambda implements Function1<C2763c.C2764a, JSONArray> {
    public static final AttachComponentMethod$handleResult$paths$1 INSTANCE = new AttachComponentMethod$handleResult$paths$1();
    ...
    public AttachComponentMethod$handleResult$paths$1() {
        super(1);
    }
