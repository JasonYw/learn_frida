...
public final class PreviewPaidLiveInfoWidget$timeInfoTextView$2 extends Lambda implements Function0<TextView> {
    ...
    public PreviewPaidLiveInfoWidget$timeInfoTextView$2(PreviewPaidLiveInfoWidget previewPaidLiveInfoWidget) {
        super(0);
    ...
    public final /* synthetic */ TextView mo30099invoke() {
        ...
        ?? LIZ = C116971W2r.LIZ(LayoutInflater.from(this.this$0.context), 2131698470, (ViewGroup) this.this$0.LJFF, false);
        if (LIZ != 0) {
            return LIZ;
        }
