...
public final class LiveGameDebugService$startLiveGameDebug$1 extends Lambda implements Function0<Unit> {
    ...
    public LiveGameDebugService$startLiveGameDebug$1(LiveGameDebugService liveGameDebugService) {
        super(0);
    ...
    public final /* synthetic */ Unit mo30099invoke() {
        ...
        if (!PatchProxy.proxy(new Object[0], this, changeQuickRedirect, false, 1).isSupported) {
            ...
            this.this$0.containerViewVisible = true;
        }
