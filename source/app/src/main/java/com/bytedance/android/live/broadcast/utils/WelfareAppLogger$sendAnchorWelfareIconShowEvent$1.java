...
public final class WelfareAppLogger$sendAnchorWelfareIconShowEvent$1 extends Lambda implements Function1<HashMap<String, String>, Unit> {
    ...
    public WelfareAppLogger$sendAnchorWelfareIconShowEvent$1(boolean z) {
        super(1);
        this.$isLiving = z;
    }
