...
/* renamed from: com.bytedance.android.live.broadcast.bgbroadcast.game.mirror.d */
...
public final class C2940d {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof C2940d) {
            return C106862S5w.LIZ(((C2940d) obj).LIZ(), LIZ());
        }
        return false;
    }
    ...
    public final String toString() {
        ...
        return proxy.isSupported ? (String) proxy.result : C106862S5w.LIZ("MirrorEvent:%s,%s", LIZ());
    }

    public C2940d(int i, Bundle bundle) {
        this.LIZIZ = i;
        this.LIZJ = bundle;
    }
}
