...
public final class LiveLynxComponent$LiveLynxClient$shouldRedirectImageUrl$1 extends Lambda implements Function1<String, Pair<? extends String, ? extends Integer>> {
    ...
    public LiveLynxComponent$LiveLynxClient$shouldRedirectImageUrl$1(String str) {
        super(1);
        this.$url = str;
    }
