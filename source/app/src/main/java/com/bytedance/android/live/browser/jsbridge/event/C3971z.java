...
/* renamed from: com.bytedance.android.live.browser.jsbridge.event.z */
...
public final class C3971z {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof C3971z) {
            return C106862S5w.LIZ(((C3971z) obj).LIZ(), LIZ());
        }
        return false;
    }
    ...
    public final String toString() {
        ...
        return proxy.isSupported ? (String) proxy.result : C106862S5w.LIZ("RefreshActivityBannerNumberEvent:%s", LIZ());
    }
