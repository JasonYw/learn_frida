...
/* renamed from: com.bytedance.android.live.liveinteract.view.PositionNameCountDownController$hideCountDownTimerAndShowHostLabel$$inlined$let$lambda$1 */
/* loaded from: classes3.dex */
public final class C4968x7b71d22f extends Lambda implements Function1<Animator, Unit> {
    ...
    public C4968x7b71d22f(C81130HyO c81130HyO) {
        super(1);
    ...
    public final /* synthetic */ Unit invoke(Animator animator) {
        if (!PatchProxy.proxy(new Object[]{animator}, this, changeQuickRedirect, false, 1).isSupported) {
            ...
            this.this$0.f7393LJ.setVisibility(0);
        }
