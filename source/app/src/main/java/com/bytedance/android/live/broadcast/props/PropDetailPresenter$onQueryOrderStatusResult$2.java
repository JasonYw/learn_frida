...
public final class PropDetailPresenter$onQueryOrderStatusResult$2 extends Lambda implements Function1<C3952am, Unit> {
    ...
    public PropDetailPresenter$onQueryOrderStatusResult$2(C3231j c3231j) {
        super(1);
        this.this$0 = c3231j;
    }
