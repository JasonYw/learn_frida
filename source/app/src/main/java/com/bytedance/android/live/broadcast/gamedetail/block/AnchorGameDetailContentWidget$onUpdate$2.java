...
public final class AnchorGameDetailContentWidget$onUpdate$2 extends Lambda implements Function1<Boolean, Unit> {
    ...
    public AnchorGameDetailContentWidget$onUpdate$2(AnchorGameDetailContentWidget anchorGameDetailContentWidget) {
        super(1);
    ...
    public final /* synthetic */ Unit invoke(Boolean bool) {
        ...
        if (!PatchProxy.proxy(new Object[]{Byte.valueOf(booleanValue == true ? (byte) 1 : (byte) 0)}, this, changeQuickRedirect, false, 1).isSupported) {
            ...
            if (!PatchProxy.proxy(new Object[]{Byte.valueOf((byte) booleanValue)}, anchorGameDetailContentWidget, AnchorGameDetailContentWidget.LIZ, false, 6).isSupported) {
                if (booleanValue != 0) {
                    anchorGameDetailContentWidget.LIZ().LJIIJJI();
                } else {
                    anchorGameDetailContentWidget.LIZ().LJIIL();
                }
            }
        }
