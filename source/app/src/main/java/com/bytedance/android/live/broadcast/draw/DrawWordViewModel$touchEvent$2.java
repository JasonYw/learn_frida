...
public final class DrawWordViewModel$touchEvent$2 extends Lambda implements Function0<NextLiveData<Integer>> {
    public static final DrawWordViewModel$touchEvent$2 INSTANCE = new DrawWordViewModel$touchEvent$2();
    ...
    public DrawWordViewModel$touchEvent$2() {
        super(0);
    }
