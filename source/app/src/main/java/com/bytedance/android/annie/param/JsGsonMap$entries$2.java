...
public final class JsGsonMap$entries$2 extends Lambda implements Function0<LinkedHashSet<Map.Entry<? extends String, ? extends Object>>> {
    public static ChangeQuickRedirect changeQuickRedirect;
    public final /* synthetic */ QP5 this$0;
    ...
    public JsGsonMap$entries$2(QP5 qp5) {
        super(0);
        this.this$0 = qp5;
    }
    ...
    public final /* synthetic */ LinkedHashSet<Map.Entry<? extends String, ? extends Object>> mo30099invoke() {
        ...
        Set<Map.Entry<String, JsonElement>> entrySet = this.this$0.LIZLLL.entrySet();
        Intrinsics.checkNotNullExpressionValue(entrySet, "");
        LinkedHashSet<Map.Entry<? extends String, ? extends Object>> linkedHashSet = new LinkedHashSet<>();
        Iterator<T> it = entrySet.iterator();
        while (it.hasNext()) {
            linkedHashSet.add(new QP6((Map.Entry) it.next()));
        }
