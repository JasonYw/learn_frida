...
/* renamed from: com.bytedance.android.live.liveinteract.chatroom.chatroom.vm.LinkBidViewModel$onCleared$1 */
/* loaded from: classes3.dex */
public final class LinkBidViewModel$onCleared$1 extends Lambda implements Function1<IMessageManager, Unit> {
    ...
    public LinkBidViewModel$onCleared$1(C4378a c4378a) {
        super(1);
        this.this$0 = c4378a;
    }
    ...
    public final /* synthetic */ Unit invoke(IMessageManager iMessageManager) {
        ...
        if (!PatchProxy.proxy(new Object[]{iMessageManager2}, this, changeQuickRedirect, false, 1).isSupported) {
            ...
            iMessageManager2.removeMessageListener(this.this$0);
        }
