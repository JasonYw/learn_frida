...
public final class DrawWordViewModel$gameControlEvent$2 extends Lambda implements Function0<NextLiveData<Integer>> {
    public static final DrawWordViewModel$gameControlEvent$2 INSTANCE = new DrawWordViewModel$gameControlEvent$2();
    ...
    public DrawWordViewModel$gameControlEvent$2() {
        super(0);
    }
