...
public final class DrawWordViewModel$playId$2 extends Lambda implements Function0<NextLiveData<Long>> {
    public static final DrawWordViewModel$playId$2 INSTANCE = new DrawWordViewModel$playId$2();
    ...
    public DrawWordViewModel$playId$2() {
        super(0);
    }
