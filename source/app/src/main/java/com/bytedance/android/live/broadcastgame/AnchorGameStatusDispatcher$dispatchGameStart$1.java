...
public final class AnchorGameStatusDispatcher$dispatchGameStart$1 extends Lambda implements Function1<m$b, Unit> {
    ...
    public AnchorGameStatusDispatcher$dispatchGameStart$1(C3384q c3384q) {
        super(1);
        this.$game = c3384q;
    }
