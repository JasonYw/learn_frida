...
/* renamed from: com.bytedance.android.live.liveinteract.view.PositionNameCountDownController$hideCountDownTimerAndShowPositionName$countDownViewFadeOutAnimator$1 */
/* loaded from: classes3.dex */
public final class C4978x8c3afecd extends Lambda implements Function1<Animator, Unit> {
    ...
    public C4978x8c3afecd(C81130HyO c81130HyO) {
        super(1);
    ...
    public final /* synthetic */ Unit invoke(Animator animator) {
        if (!PatchProxy.proxy(new Object[]{animator}, this, changeQuickRedirect, false, 1).isSupported) {
            ...
            this.this$0.LIZLLL.setVisibility(8);
        }
