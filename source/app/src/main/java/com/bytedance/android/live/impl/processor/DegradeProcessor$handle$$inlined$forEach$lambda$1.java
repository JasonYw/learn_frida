...
public final class DegradeProcessor$handle$$inlined$forEach$lambda$1 extends Lambda implements Function1<String, Boolean> {
    ...
    public final /* synthetic */ C147437fJ1 this$0;
    ...
    public DegradeProcessor$handle$$inlined$forEach$lambda$1(C5731c c5731c, C147437fJ1 c147437fJ1, Map map, C127309a3T c127309a3T, String str, Object obj) {
        super(1);
        this.$comInfo$inlined = c5731c;
        this.this$0 = c147437fJ1;
                        ...
                        if (!Intrinsics.areEqual("all not", c5730b.f26742LJ)) {
                            ...
                            if (map != null) {
                                if (map.containsKey(str2)) {
                                    ...
                                    C147437fJ1 c147437fJ1 = this.this$0;
                                    String str3 = c5730b.LIZIZ;
                                    if (str3 == null) {
                                        str3 = "";
                                    }
                                    LIZ = c147437fJ1.LIZ(str3);
