...
public final class AnnieParamUtil$getCacheParam$1 extends Lambda implements Function1<String, JsonElement> {
    public static final AnnieParamUtil$getCacheParam$1 INSTANCE = new AnnieParamUtil$getCacheParam$1();
    ...
    public AnnieParamUtil$getCacheParam$1() {
        super(1);
    }
    ...
    public final /* synthetic */ JsonElement invoke(String str) {
        ...
        C106862S5w.LIZ(str2);
        AbstractC101043Pqn<?> LIZ = C2628b.LIZLLL.LIZ(IRA.LIZ.LIZ());
        if (LIZ != null) {
