...
public final class GameCenterStrategy$subscribe$1$onStateChanged$6 extends Lambda implements Function0<Unit> {
    public static ChangeQuickRedirect changeQuickRedirect;
    public final /* synthetic */ int $failStatus;
    ...
    public GameCenterStrategy$subscribe$1$onStateChanged$6(C89255LEr c89255LEr, int i) {
        super(0);
    ...
    public final /* synthetic */ Unit mo30099invoke() {
        if (!PatchProxy.proxy(new Object[0], this, changeQuickRedirect, false, 1).isSupported) {
            ...
            if (abstractC2889a != null) {
                abstractC2889a.LIZIZ(this.$failStatus);
            }
        }
