...
public final class MiniAppAnchorPluginManager$checkLastPluginStatus$1 extends Lambda implements Function3<Long, Long, String, Unit> {
    ...
    public MiniAppAnchorPluginManager$checkLastPluginStatus$1(Ref.ObjectRef objectRef) {
        super(3);
        this.$copy = objectRef;
    }
