...
public final class MockMiniApp$schema$2 extends Lambda implements Function0<String> {
    ...
    public MockMiniApp$schema$2(MockMiniApp mockMiniApp) {
        super(0);
    ...
    public final /* synthetic */ String mo30099invoke() {
        ...
        return this.this$0.getIntent().getStringExtra("mini_app_schema");
    }
}
