...
public final /* synthetic */ class BaseLatchProcess$createJsWorker$3$2 extends FunctionReference implements Function1<String, Unit> {
    ...
    public BaseLatchProcess$createJsWorker$3$2(AbstractC137655ckl abstractC137655ckl) {
    ...
    public final /* synthetic */ Unit invoke(String str) {
        ...
        if (!PatchProxy.proxy(new Object[]{str2}, this, changeQuickRedirect, false, 1).isSupported) {
            C106862S5w.LIZ(str2);
            ((AbstractC137655ckl) this.receiver).LIZJ(str2);
        }
