...
public final class SonicGamePlugin$initSonicContext$1 extends Lambda implements Function1<AbstractC3609d, Unit> {
    public static ChangeQuickRedirect changeQuickRedirect;
    public final /* synthetic */ String $btnColor;
    ...
    public SonicGamePlugin$initSonicContext$1(String str) {
        super(1);
        this.$btnColor = str;
    }
    ...
    public final /* synthetic */ Unit invoke(AbstractC3609d abstractC3609d) {
        ...
        if (!PatchProxy.proxy(new Object[]{abstractC3609d2}, this, changeQuickRedirect, false, 1).isSupported) {
            ...
            abstractC3609d2.LIZ(true ^ Intrinsics.areEqual(this.$btnColor, "white"));
        }
