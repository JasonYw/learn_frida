...
public final class TalkRoomNormalApplyTitleViewHolder$currentOrder$2 extends Lambda implements Function0<TextView> {
    ...
    public TalkRoomNormalApplyTitleViewHolder$currentOrder$2(View view) {
        super(0);
        this.$itemView = view;
    }
