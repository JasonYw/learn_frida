...
/* renamed from: com.bytedance.android.annie.protobuf.ExternalProtobufMessageDefinitions$Message$$special$$inlined$also$lambda$1 */
/* loaded from: classes.dex */
public final class C2615x63ff7871 extends Lambda implements Function1<String, Pair<? extends String, ? extends JsonObject>> {
    ...
    public C2615x63ff7871(JsonObject jsonObject) {
        super(1);
