...
/* renamed from: com.bytedance.android.live.broadcastgame.common.network.f */
...
public final class C3452f {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof C3452f) {
            return C106862S5w.LIZ(((C3452f) obj).LIZ(), LIZ());
        }
        return false;
    }
    ...
    public final String toString() {
        ...
        return proxy.isSupported ? (String) proxy.result : C106862S5w.LIZ("RankListMetaData:%s,%s", LIZ());
    }
}
