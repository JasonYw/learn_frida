...
public final class AudiencePluginManager$showPlugin$4$1 extends Lambda implements Function0<Unit> {
    ...
    public AudiencePluginManager$showPlugin$4$1(C87746Kho c87746Kho) {
        super(0);
    ...
    public final /* synthetic */ Unit mo30099invoke() {
        ...
        if (!PatchProxy.proxy(new Object[0], this, changeQuickRedirect, false, 1).isSupported) {
            ...
            kw0.LIZ(l, str, this.this$0.LIZIZ.LIZJ.LIZ(), "cancel");
