...
public final class AnnieParamUtil$getCacheParam$4 extends Lambda implements Function1<Map<String, ? extends Object>, Unit> {
    ...
    public AnnieParamUtil$getCacheParam$4(C2613i c2613i) {
        super(1);
        this.$param = c2613i;
    }
