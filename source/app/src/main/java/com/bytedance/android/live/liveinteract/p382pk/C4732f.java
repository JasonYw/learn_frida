...
/* renamed from: com.bytedance.android.live.liveinteract.pk.f */
/* loaded from: classes3.dex */
public final class C4732f extends C13491f {
    ...
    static {
        ...
        PropertyReference1Impl propertyReference1Impl = new PropertyReference1Impl(C4732f.class, "service", "getService()Lcom/bytedance/live/datacontext/IConstantNullable;", 0);
        Reflection.property1(propertyReference1Impl);
        LIZIZ = new KProperty[]{propertyReference1Impl};
    }

    public final AbstractC413392Xt<AbstractC4784x> LIZ() {
