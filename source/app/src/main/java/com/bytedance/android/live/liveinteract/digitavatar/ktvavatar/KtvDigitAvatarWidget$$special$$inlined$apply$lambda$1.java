...
public final class KtvDigitAvatarWidget$$special$$inlined$apply$lambda$1 extends Lambda implements Function2<Integer, Boolean, Unit> {
    ...
    public KtvDigitAvatarWidget$$special$$inlined$apply$lambda$1(KtvDigitAvatarWidget ktvDigitAvatarWidget) {
        super(2);
    ...
    public final /* synthetic */ Unit invoke(Integer num, Boolean bool) {
        ...
        if (!PatchProxy.proxy(new Object[]{Integer.valueOf(num.intValue()), Byte.valueOf(bool.booleanValue() ? (byte) 1 : (byte) 0)}, this, changeQuickRedirect, false, 1).isSupported && this.this$0.LJI == KtvSingMode.DIGIT_AVATAR) {
