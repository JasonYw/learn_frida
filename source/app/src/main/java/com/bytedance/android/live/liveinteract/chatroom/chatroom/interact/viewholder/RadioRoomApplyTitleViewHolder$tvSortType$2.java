...
public final class RadioRoomApplyTitleViewHolder$tvSortType$2 extends Lambda implements Function0<TextView> {
    ...
    public RadioRoomApplyTitleViewHolder$tvSortType$2(View view) {
        super(0);
        this.$itemView = view;
    }
