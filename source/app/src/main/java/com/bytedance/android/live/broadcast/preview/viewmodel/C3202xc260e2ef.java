...
/* renamed from: com.bytedance.android.live.broadcast.preview.viewmodel.StartLiveVisibilityContext$refreshOneLimitList$$inlined$let$lambda$1 */
/* loaded from: classes3.dex */
public final class C3202xc260e2ef extends Lambda implements Function2<List<C3195i>, Boolean, Unit> {
    ...
    public C3202xc260e2ef(C3209g c3209g, C3207d c3207d, int i) {
        super(2);
        this.$it = c3209g;
        this.this$0 = c3207d;
    ...
    public final /* synthetic */ Unit invoke(List<C3195i> list, Boolean bool) {
        ...
        if (!PatchProxy.proxy(new Object[]{list2, Byte.valueOf(booleanValue ? (byte) 1 : (byte) 0)}, this, changeQuickRedirect, false, 1).isSupported) {
            if (list2 != null) {
                this.$it.LIZLLL.clear();
                this.$it.LIZLLL.addAll(list2);
            }
            this.this$0.LIZ(CollectionsKt___CollectionsKt.toMutableList((Collection) this.$it.LIZLLL), booleanValue);
