...
public final class MiniAppCardSettingDialog$onCreate$2 extends Lambda implements Function1<C3779b, Unit> {
    ...
    public MiniAppCardSettingDialog$onCreate$2(MiniAppCardSettingDialog miniAppCardSettingDialog) {
        super(1);
