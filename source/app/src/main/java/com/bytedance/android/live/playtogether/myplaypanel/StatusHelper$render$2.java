...
public final class StatusHelper$render$2 extends Lambda implements Function1<View, Unit> {
    ...
    public StatusHelper$render$2(LT5 lt5, C5212l c5212l) {
        super(1);
        this.this$0 = lt5;
        this.$order = c5212l;
    }
    ...
    public final /* synthetic */ Unit invoke(View view) {
        if (!PatchProxy.proxy(new Object[]{view}, this, changeQuickRedirect, false, 1).isSupported) {
            C106862S5w.LIZ(view);
            this.this$0.LJI.LIZ(this.$order);
        }
