...
public final class AudioTalkBeInvitedDialog$onViewCreated$7 extends Lambda implements Function1<View, Unit> {
    ...
    public AudioTalkBeInvitedDialog$onViewCreated$7(C78958HAq c78958HAq) {
        super(1);
        ...
        if (!PatchProxy.proxy(new Object[]{view}, this, changeQuickRedirect, false, 1).isSupported) {
            ...
            if (room != null && (c8854es = this.this$0.LJFF) != null) {
                ...
                if (LIZ != null) {
                    ...
                    LIZ.LIZ(id, str, ReplyType.Agree.ordinal());
                }
                this.this$0.dismiss();
            }
        }
