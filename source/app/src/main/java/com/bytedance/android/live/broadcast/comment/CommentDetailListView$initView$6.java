...
public final class CommentDetailListView$initView$6 extends Lambda implements Function1<Boolean, Unit> {
    ...
    public CommentDetailListView$initView$6(CommentDetailListView commentDetailListView) {
        super(1);
