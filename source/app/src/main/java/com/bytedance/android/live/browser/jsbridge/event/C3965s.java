...
/* renamed from: com.bytedance.android.live.browser.jsbridge.event.s */
...
public final class C3965s {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof C3965s) {
            return C106862S5w.LIZ(((C3965s) obj).LIZ(), LIZ());
        }
        return false;
    }
    ...
    public final String toString() {
        ...
        return proxy.isSupported ? (String) proxy.result : C106862S5w.LIZ("OpenVerifyResultEvent:%s", LIZ());
    }
}
