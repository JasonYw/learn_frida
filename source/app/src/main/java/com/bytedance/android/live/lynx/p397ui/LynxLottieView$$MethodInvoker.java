...
/* renamed from: com.bytedance.android.live.lynx.ui.LynxLottieView$$MethodInvoker */
/* loaded from: classes10.dex */
public class LynxLottieView$$MethodInvoker implements LynxUIMethodInvoker<LynxLottieView> {
    ...
    public void invoke(LynxLottieView lynxLottieView, String str, ReadableMap readableMap, Callback callback) {
        if (PatchProxy.proxy(new Object[]{lynxLottieView, str, readableMap, callback}, this, changeQuickRedirect, false, 1).isSupported) {
            return;
        }
        try {
            switch (str.hashCode()) {
