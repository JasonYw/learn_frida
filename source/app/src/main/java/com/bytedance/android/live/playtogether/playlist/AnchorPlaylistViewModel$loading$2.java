...
public final class AnchorPlaylistViewModel$loading$2 extends Lambda implements Function0<MutableLiveData<Boolean>> {
    public static final AnchorPlaylistViewModel$loading$2 INSTANCE = new AnchorPlaylistViewModel$loading$2();
    ...
    public AnchorPlaylistViewModel$loading$2() {
        super(0);
    }
