...
public final class PromoteListAdapter$onBindViewHolder$5 extends Lambda implements Function1<String, Unit> {
    ...
    public PromoteListAdapter$onBindViewHolder$5(L9Y l9y, Function1 function1) {
        super(1);
        this.this$0 = l9y;
    ...
    public final /* synthetic */ Unit invoke(String str) {
        ...
        if (!PatchProxy.proxy(new Object[]{str2}, this, changeQuickRedirect, false, 1).isSupported) {
            C106862S5w.LIZ(str2);
            this.$addFoot.invoke(new L3Q(this.this$0.LIZIZ, str2, null, null, 12));
        }
