...
public final class LinkRoomFightReplyDialog$initView$3 extends Lambda implements Function1<View, Unit> {
    ...
    public LinkRoomFightReplyDialog$initView$3(C78790H4e c78790H4e) {
        super(1);
    ...
    public final /* synthetic */ Unit invoke(View view) {
        if (!PatchProxy.proxy(new Object[]{view}, this, changeQuickRedirect, false, 1).isSupported) {
            C106862S5w.LIZ(view);
            this.this$0.LIZ(ReplyType.AGREE, ReplyReason.MANUAL);
            this.this$0.dismiss();
        }
