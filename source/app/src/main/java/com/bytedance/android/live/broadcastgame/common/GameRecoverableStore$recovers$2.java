...
public final class GameRecoverableStore$recovers$2 extends Lambda implements Function0<List<w$a>> {
    public static final GameRecoverableStore$recovers$2 INSTANCE = new GameRecoverableStore$recovers$2();
    ...
    public GameRecoverableStore$recovers$2() {
        super(0);
    }
