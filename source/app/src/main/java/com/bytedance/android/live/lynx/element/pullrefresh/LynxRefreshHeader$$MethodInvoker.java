...
public class LynxRefreshHeader$$MethodInvoker implements LynxUIMethodInvoker<LynxRefreshHeader> {
    ...
    public void invoke(LynxRefreshHeader lynxRefreshHeader, String str, ReadableMap readableMap, Callback callback) {
        if (PatchProxy.proxy(new Object[]{lynxRefreshHeader, str, readableMap, callback}, this, changeQuickRedirect, false, 1).isSupported) {
            return;
        }
        try {
            switch (str.hashCode()) {
