...
/* renamed from: com.bytedance.android.live.liveinteract.multianchor.match.d */
...
public final class C4532d {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof C4532d) {
            return C106862S5w.LIZ(((C4532d) obj).LIZ(), LIZ());
        }
        return false;
    }
    ...
    public final String toString() {
        ...
        return proxy.isSupported ? (String) proxy.result : C106862S5w.LIZ("MultiMatchSuccessEvent:%s", LIZ());
    }

    public C4532d(boolean z) {
        this.LIZIZ = z;
    }
}
