...
public final class DialogMethod$showConfirmDialog$$inlined$apply$lambda$2 extends Lambda implements Function2<DialogInterface, Integer, Unit> {
    ...
    public DialogMethod$showConfirmDialog$$inlined$apply$lambda$2(Q06 q06, aw$a aw_a, Ref.ObjectRef objectRef) {
        super(2);
        this.this$0 = q06;
    ...
    public final /* synthetic */ Unit invoke(DialogInterface dialogInterface, Integer num) {
        if (!PatchProxy.proxy(new Object[]{dialogInterface, Integer.valueOf(num.intValue())}, this, changeQuickRedirect, false, 1).isSupported) {
            ...
            this.this$0.finishWithResult(new aw$b(1, "left"));
