...
public final class LiveLynxComponent$updateCacheParams$4 extends Lambda implements Function1<Map<String, ? extends Object>, Unit> {
    ...
    public LiveLynxComponent$updateCacheParams$4(C101347Pvh c101347Pvh) {
        super(1);
