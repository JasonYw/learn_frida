...
/* renamed from: com.amap.api.services.a.bn */
/* loaded from: classes19.dex */
public class C1888bn {
    static {
        Covode.recordClassIndex(5499);
    }

    public static Cursor com_amap_api_services_a_bn_android_content_ContentResolver_query(ContentResolver contentResolver, Uri uri, String[] strArr, String str, String[] strArr2, String str2) {
        ...
        ActionInvokeEntrance.actionInvoke(LIZ, contentResolver, new Object[]{uri, strArr, str, strArr2, str2}, 240004, "com_amap_api_services_a_bn_android_content_ContentResolver_query(Landroid/content/ContentResolver;Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;");
        return LIZ;
    }

    /* renamed from: b */
    public static int m16821b() {
        try {
            return Proxy.getDefaultPort();
        } catch (Throwable th) {
            C1906cb.m16716c(th, "pu", "gdp");
            return -1;
        }
    }

    /* renamed from: a */
    public static String m16826a() {
        String str;
        try {
            str = Proxy.getDefaultHost();
        } catch (Throwable th) {
            C1906cb.m16716c(th, "pu", "gdh");
            str = null;
        }
        if (str == null) {
            return "null";
    ...
    /* renamed from: a */
    public static String m16823a(String str) {
        return C1892bp.m16776c(str);
    }

    /* renamed from: c */
    public static boolean m16819c(Context context) {
        if (C1878bj.m16873s(context) == 0) {
            return true;
        }
        return false;
    }
    ...
    /* renamed from: a */
    public static java.net.Proxy m16825a(Context context) {
        try {
            int i = Build.VERSION.SDK_INT;
            return m16824a(context, new URI("http://restapi.amap.com"));
        } catch (Throwable th) {
            C1906cb.m16716c(th, "pu", "gp");
            return null;
        }
    }
    ...
    */
    public static java.net.Proxy m16820b(android.content.Context r21) {
        /*
            Method dump skipped, instructions count: 345
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.amap.api.services.p126a.C1888bn.m16820b(android.content.Context):java.net.Proxy");
    }

    /* renamed from: a */
    public static boolean m16822a(String str, int i) {
    ...
    /* renamed from: a */
    public static java.net.Proxy m16824a(Context context, URI uri) {
