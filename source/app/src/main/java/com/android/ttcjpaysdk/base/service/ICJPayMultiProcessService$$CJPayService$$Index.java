...
public class ICJPayMultiProcessService$$CJPayService$$Index {
    ...
    public static void initService(Map<Class, ICJPayService> map) {
        ...
        map.put(ICJPayMultiProcessService.class, createService("com.android.ttcjpaysdk.multiprocess.CJPayMultiProcessProvider"));
    }
