...
public class ICJPayFrontCardListService$$CJPayService$$Index {
    ...
    public static void initService(Map<Class, ICJPayService> map) {
        ...
        map.put(ICJPayFrontCardListService.class, createService("com.android.ttcjpaysdk.thirdparty.front.cardlist.CJPayFrontCardListProvider"));
    }
