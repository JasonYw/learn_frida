...
/* renamed from: com.android.ttcjpaysdk.bindcard.quickbind.ui.SelectBankCardType2Activity$initActions$3 */
/* loaded from: classes17.dex */
public final class SelectBankCardType2Activity$initActions$3 extends Lambda implements Function1<RelativeLayout, Unit> {
    ...
    public SelectBankCardType2Activity$initActions$3(SelectBankCardType2Activity selectBankCardType2Activity) {
        super(1);
    ...
    public final /* synthetic */ Unit invoke(RelativeLayout relativeLayout) {
        if (!PatchProxy.proxy(new Object[]{relativeLayout}, this, changeQuickRedirect, false, 1).isSupported) {
            ...
            this.this$0.LIZ("CREDIT");
            this.this$0.LIZ(false, true);
            this.this$0.LIZ();
