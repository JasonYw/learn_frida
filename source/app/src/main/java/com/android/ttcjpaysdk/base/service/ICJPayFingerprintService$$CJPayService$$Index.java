...
public class ICJPayFingerprintService$$CJPayService$$Index {
    ...
    public static void initService(Map<Class, ICJPayService> map) {
        ...
        map.put(ICJPayFingerprintService.class, createService("com.android.ttcjpaysdk.thirdparty.fingerprint.CJPayFingerprintService"));
    }
