...
public class ICJPayFaceCheckService$$CJPayService$$Index {
    ...
    public static void initService(Map<Class, ICJPayService> map) {
        ...
        map.put(ICJPayFaceCheckService.class, createService("com.android.ttcjpaysdk.facelive.CJPayFaceCheckProvider"));
    }
