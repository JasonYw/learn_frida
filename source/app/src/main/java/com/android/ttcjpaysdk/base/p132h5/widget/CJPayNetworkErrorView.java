package com.android.ttcjpaysdk.base.p132h5.widget;
...
public class CJPayNetworkErrorView extends FrameLayout {
    ...
    public void onDetachedFromWindow() {
        ...
        EventManager.INSTANCE.unregister(this.f25448LJ);
    }

    public void setOnRefreshBenClickListener(AbstractC135666cEf abstractC135666cEf) {
        this.LIZIZ = abstractC135666cEf;
    }
    ...
    public void onWindowFocusChanged(boolean z) {
        ...
        if (z) {
            EventManager.INSTANCE.register(this.f25448LJ);
        } else {
            EventManager.INSTANCE.unregister(this.f25448LJ);
        }
    }
    ...
    private void LIZJ(Context context) {
        ...
        this.LIZJ.setOnClickListener(new AbstractView$OnClickListenerC137362cg2() { // from class: com.android.ttcjpaysdk.base.h5.widget.CJPayNetworkErrorView.1
            public static ChangeQuickRedirect LIZ;
    ...
    public CJPayNetworkErrorView(Context context, AttributeSet attributeSet, int i) {
        ...
        MethodCollector.m14708i(373);
        this.f25448LJ = new AbstractC2126a() { // from class: com.android.ttcjpaysdk.base.h5.widget.CJPayNetworkErrorView.2
            public static ChangeQuickRedirect LIZ;
        ...
        if (!PatchProxy.proxy(new Object[]{context}, this, LIZ, false, 1).isSupported) {
            ...
            if (this.LIZLLL == null) {
                LIZJ(context);
                MethodCollector.m14707o(373);
                return;
            } else if (!(context instanceof AbstractActivityC136021cKO)) {
                LIZJ(context);
                MethodCollector.m14707o(373);
                return;
