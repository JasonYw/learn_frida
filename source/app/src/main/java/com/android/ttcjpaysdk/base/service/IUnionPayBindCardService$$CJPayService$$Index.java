...
public class IUnionPayBindCardService$$CJPayService$$Index {
    ...
    public static void initService(Map<Class, ICJPayService> map) {
        ...
        map.put(IUnionPayBindCardService.class, createService("com.android.ttcjpaysdk.bindcard.unionpay.UnionPayBindCardProvider"));
    }
