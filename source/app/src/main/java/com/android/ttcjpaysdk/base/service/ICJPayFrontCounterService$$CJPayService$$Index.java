...
public class ICJPayFrontCounterService$$CJPayService$$Index {
    ...
    public static void initService(Map<Class, ICJPayService> map) {
        ...
        map.put(ICJPayFrontCounterService.class, createService("com.android.ttcjpaysdk.thirdparty.front.counter.utils.CJPayFrontCounterProvider"));
    }
