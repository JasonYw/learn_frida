...
public class ICJPayWithdrawService$$CJPayService$$Index {
    ...
    public static void initService(Map<Class, ICJPayService> map) {
        ...
        map.put(ICJPayWithdrawService.class, createService("com.android.ttcjpaysdk.thirdparty.balancewithdraw.utils.CJPayWithdrawProvider"));
    }
