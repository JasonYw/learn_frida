...
public class ICJPayAgreementService$$CJPayService$$Index {
    ...
    public static void initService(Map<Class, ICJPayService> map) {
        ...
        map.put(ICJPayAgreementService.class, createService("com.android.ttcjpaysdk.thirdparty.agreement.CJPayAgreementService"));
    }
