...
/* renamed from: com.android.ttcjpaysdk.bindcard.quickbind.ui.SelectBankCardTypeActivity$initActions$2 */
/* loaded from: classes17.dex */
public final class SelectBankCardTypeActivity$initActions$2 extends Lambda implements Function1<RelativeLayout, Unit> {
    ...
    public SelectBankCardTypeActivity$initActions$2(SelectBankCardTypeActivity selectBankCardTypeActivity) {
        super(1);
    ...
    public final /* synthetic */ Unit invoke(RelativeLayout relativeLayout) {
        if (!PatchProxy.proxy(new Object[]{relativeLayout}, this, changeQuickRedirect, false, 1).isSupported) {
            ...
            selectBankCardTypeActivity.LJIJJLI = "DEBIT";
            selectBankCardTypeActivity.LIZ(true, false);
