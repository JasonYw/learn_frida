...
public class ICJPaySupplementarySignService$$CJPayService$$Index {
    ...
    public static void initService(Map<Class, ICJPayService> map) {
        ...
        map.put(ICJPaySupplementarySignService.class, createService("com.android.ttcjpaysdk.thirdparty.supplementarysign.utils.CJPaySupplementarySignProvider"));
    }
