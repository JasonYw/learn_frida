...
public class ICJPayNormalBindCardService$$CJPayService$$Index {
    ...
    public static void initService(Map<Class, ICJPayService> map) {
        ...
        map.put(ICJPayNormalBindCardService.class, createService("com.android.ttcjpaysdk.bdpay.bindcard.normal.CJPayNormalBindCardProvider"));
    }
