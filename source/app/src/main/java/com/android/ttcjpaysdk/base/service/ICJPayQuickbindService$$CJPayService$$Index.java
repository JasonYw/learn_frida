...
public class ICJPayQuickbindService$$CJPayService$$Index {
    ...
    public static void initService(Map<Class, ICJPayService> map) {
        ...
        map.put(ICJPayQuickbindService.class, createService("com.android.ttcjpaysdk.bindcard.quickbind.CJPayQuickbindProvider"));
    }
