...
public final class UnionPayTwoElementLogger$agreementClick$1 extends Lambda implements Function1<CJPayCardProtocolBean, CharSequence> {
    public static final UnionPayTwoElementLogger$agreementClick$1 INSTANCE = new UnionPayTwoElementLogger$agreementClick$1();
    ...
    public UnionPayTwoElementLogger$agreementClick$1() {
        super(1);
    }
