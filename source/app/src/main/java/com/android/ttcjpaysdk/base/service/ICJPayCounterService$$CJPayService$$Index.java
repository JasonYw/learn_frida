...
public class ICJPayCounterService$$CJPayService$$Index {
    ...
    public static void initService(Map<Class, ICJPayService> map) {
        ...
        map.put(ICJPayCounterService.class, createService("com.android.ttcjpaysdk.thirdparty.counter.utils.CJPayCheckoutCounterProvider"));
    }
