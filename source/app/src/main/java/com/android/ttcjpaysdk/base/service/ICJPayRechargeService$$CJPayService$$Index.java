...
public class ICJPayRechargeService$$CJPayService$$Index {
    ...
    public static void initService(Map<Class, ICJPayService> map) {
        ...
        map.put(ICJPayRechargeService.class, createService("com.android.ttcjpaysdk.thirdparty.balancerecharge.utils.CJPayRechargeProvider"));
    }
