...
public class ICJPayVerifyFastPayService$$CJPayService$$Index {
    ...
    public static void initService(Map<Class, ICJPayService> map) {
        ...
        map.put(ICJPayVerifyFastPayService.class, createService("com.android.ttcjpaysdk.thirdparty.verify.provider.CJPayVerifyFastPayProvider"));
    }
