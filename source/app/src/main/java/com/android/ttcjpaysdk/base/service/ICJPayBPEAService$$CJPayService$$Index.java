...
public class ICJPayBPEAService$$CJPayService$$Index {
    ...
    public static void initService(Map<Class, ICJPayService> map) {
        ...
        map.put(ICJPayBPEAService.class, createService("com.android.ttcjpaysdk.base.bpea.permission.CJPayBPEAService"));
    }
