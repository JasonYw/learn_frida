...
public final class ColorUtils {
    ...
    public static double calculateContrast(int i, int i2) {
        ...
        throw new IllegalArgumentException(C0002O.m25086C("background can not be translucent: #", Integer.toHexString(i2)));
    }
    ...
    public static int calculateMinimumAlpha(int i, int i2, float f) {
        ...
        if (alpha == 255) {
            double d = f;
            if (calculateContrast(setAlphaComponent(i, MotionEventCompat.ACTION_MASK), i2) < d) {
                return -1;
            }
            int i4 = 0;
            int i5 = 0;
    ...
    public static int XYZToColor(double d, double d2, double d3) {
        ...
        return Color.rgb(constrain((int) Math.round(d4 * 255.0d), 0, (int) MotionEventCompat.ACTION_MASK), constrain((int) Math.round(d5 * 255.0d), 0, (int) MotionEventCompat.ACTION_MASK), constrain((int) Math.round(d6 * 255.0d), 0, (int) MotionEventCompat.ACTION_MASK));
    }
    ...
    public static int compositeComponent(int i, int i2, int i3, int i4, int i5) {
        ...
        return (((i * MotionEventCompat.ACTION_MASK) * i2) + ((i3 * i4) * (255 - i2))) / (i5 * MotionEventCompat.ACTION_MASK);
    }
}
