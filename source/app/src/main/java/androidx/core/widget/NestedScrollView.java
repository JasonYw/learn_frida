...
public class NestedScrollView extends FrameLayout implements NestedScrollingChild3, NestedScrollingParent3, ScrollingView {
    public static final C139176d9Q ACCESSIBILITY_DELEGATE = new C139176d9Q();
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            return C0002O.m25083C("HorizontalScrollView.SavedState{", Integer.toHexString(System.identityHashCode(this)), " scrollPosition=", Integer.valueOf(this.LIZ), "}");
        }
                ...
                if (actionMasked != 2) {
                    ...
                    if (findPointerIndex != -1) {
                        ...
                        if (this.mIsBeingDragged) {
                            ...
                            this.mLastMotionY = i2 - iArr2[1];
                            this.mNestedYOffset += iArr2[1];
                            if (z) {
                                int i3 = i - this.mScrollConsumed[1];
                                ensureGlows();
                                int i4 = scrollY + i3;
                                if (i4 < 0) {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (!this.mIsLaidOut) {
            if (this.mSavedState != null) {
                scrollTo(getScrollX(), this.mSavedState.LIZ);
    ...
    */
    public boolean overScrollByCompat(int r18, int r19, int r20, int r21, int r22, int r23, int r24, int r25, boolean r26) {
        /*
            ...
            r2 = r17
            r2 = r2
            int r7 = r2.getOverScrollMode()
            int r5 = r2.computeHorizontalScrollRange()
            ...
            r8 = 1
        L1c:
            int r5 = r2.computeVerticalScrollRange()
            int r0 = r2.computeVerticalScrollExtent()
            if (r5 <= r0) goto L79
            r0 = 1
        L27:
            if (r7 == 0) goto L2d
        ...
        L4c:
            r3 = 1
            boolean r0 = r2.hasNestedScrollingParent(r1)
            if (r0 != 0) goto L62
            android.widget.OverScroller r10 = r2.mScroller
            r0 = 0
            r0 = 0
            r0 = 0
            int r16 = r2.getScrollRange()
            r13 = 0
            r14 = 0
            r15 = 0
            r10.springBack(r11, r12, r13, r14, r15, r16)
        L62:
            r2.onOverScrolled(r11, r12, r4, r3)
            if (r4 != 0) goto L7d
            if (r3 != 0) goto L7d
            return r9
        L6a:
