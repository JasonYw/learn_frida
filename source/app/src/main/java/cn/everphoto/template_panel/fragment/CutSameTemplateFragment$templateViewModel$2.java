...
public final class CutSameTemplateFragment$templateViewModel$2 extends Lambda implements Function0<C0803c> {
    ...
    public CutSameTemplateFragment$templateViewModel$2(C83345It1 c83345It1) {
        super(0);
