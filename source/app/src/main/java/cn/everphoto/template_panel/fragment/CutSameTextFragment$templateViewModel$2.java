...
public final class CutSameTextFragment$templateViewModel$2 extends Lambda implements Function0<C0803c> {
    ...
    public CutSameTextFragment$templateViewModel$2(C83318Isa c83318Isa) {
        super(0);
