...
public final class CutSameRootFragment$materialViewModel$2 extends Lambda implements Function0<C0801a> {
    ...
    public CutSameRootFragment$materialViewModel$2(C83339Isv c83339Isv) {
        super(0);
