...
public final class CutSameMaterialFragment$rootViewModel$2 extends Lambda implements Function0<C0802b> {
    ...
    public CutSameMaterialFragment$rootViewModel$2(C83312IsU c83312IsU) {
        super(0);
