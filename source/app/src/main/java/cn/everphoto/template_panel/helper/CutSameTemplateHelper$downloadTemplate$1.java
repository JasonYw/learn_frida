...
public final class CutSameTemplateHelper$downloadTemplate$1 extends Lambda implements Function0<IEffectNetWorker> {
    ...
    public CutSameTemplateHelper$downloadTemplate$1(IEffectNetWorker iEffectNetWorker) {
        super(0);
