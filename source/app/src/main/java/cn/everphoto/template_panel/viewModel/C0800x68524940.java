...
/* renamed from: cn.everphoto.template_panel.viewModel.CutSameMaterialViewModel$initTextEditManager$$inlined$apply$lambda$7 */
/* loaded from: classes4.dex */
public final class C0800x68524940 extends Lambda implements Function1<Long, Unit> {
    ...
    public C0800x68524940(C0801a c0801a, C84S c84s, C0790c c0790c, List list) {
        super(1);
        this.this$0 = c0801a;
    ...
    public final /* synthetic */ Unit invoke(Long l) {
        ...
        if (!PatchProxy.proxy(new Object[]{l2}, this, changeQuickRedirect, false, 1).isSupported) {
            ...
            if (abstractC83316IsY != null) {
                abstractC83316IsY.LJIJJLI(l2);
            }
            this.this$0.LJJIIZI.mo30099invoke();
        }
