...
public final class CutSameMaterialFragment$initClickListener$4 extends Lambda implements Function0<Unit> {
    ...
    public CutSameMaterialFragment$initClickListener$4(C83312IsU c83312IsU) {
        super(0);
