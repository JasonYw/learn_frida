...
public final class CutSameMaterialViewModel$launchClip$$inlined$apply$lambda$3 extends Lambda implements Function0<Unit> {
    ...
    public CutSameMaterialViewModel$launchClip$$inlined$apply$lambda$3(Intent intent, C0801a c0801a, Fragment fragment, int i, MediaItem mediaItem, Long l) {
        super(0);
    ...
    public final /* synthetic */ Unit mo30099invoke() {
        ...
        if (!PatchProxy.proxy(new Object[0], this, changeQuickRedirect, false, 1).isSupported && (abstractC83316IsY = this.this$0.LJFF) != null) {
            abstractC83316IsY.LJIIJJI(this.$id$inlined);
        }
