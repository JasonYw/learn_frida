...
public final class CutSameTextFragment$materialViewModel$2 extends Lambda implements Function0<C0801a> {
    ...
    public CutSameTextFragment$materialViewModel$2(C83318Isa c83318Isa) {
        super(0);
