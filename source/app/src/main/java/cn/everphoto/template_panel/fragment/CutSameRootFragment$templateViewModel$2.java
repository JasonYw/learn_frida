...
public final class CutSameRootFragment$templateViewModel$2 extends Lambda implements Function0<C0803c> {
    ...
    public CutSameRootFragment$templateViewModel$2(C83339Isv c83339Isv) {
        super(0);
