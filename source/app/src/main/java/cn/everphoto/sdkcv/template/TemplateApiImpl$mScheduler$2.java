...
public final class TemplateApiImpl$mScheduler$2 extends Lambda implements Function0<Scheduler> {
    public static final TemplateApiImpl$mScheduler$2 INSTANCE = new TemplateApiImpl$mScheduler$2();
    ...
    public TemplateApiImpl$mScheduler$2() {
        super(0);
    }
