...
@DebugMetadata(m136c = "cn.ever.cloud.android.api.impl.DownloadApiImpl$pauseAll$2", m135f = "DownloadApiImpl.kt", m134i = {}, m133l = {163}, m132m = "invokeSuspend", m131n = {}, m130s = {})
/* loaded from: classes23.dex */
public final class DownloadApiImpl$pauseAll$2 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public DownloadApiImpl$pauseAll$2(DownloadApiImpl downloadApiImpl, Integer num, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        ...
        return new DownloadApiImpl$pauseAll$2(this.this$0, this.$reason, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i != 0) {
            ...
            this.label = 1;
            if (taskService.pauseKind(i2, num, this) == coroutine_suspended) {
