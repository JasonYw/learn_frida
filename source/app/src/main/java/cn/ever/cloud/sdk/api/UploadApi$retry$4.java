...
@DebugMetadata(m136c = "cn.ever.cloud.sdk.api.UploadApi$retry$4", m135f = "UploadApi.kt", m134i = {}, m133l = {86}, m132m = "invokeSuspend", m131n = {}, m130s = {})
/* loaded from: classes23.dex */
public final class UploadApi$retry$4 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public UploadApi$retry$4(UploadApi uploadApi, String str, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        ...
        return new UploadApi$retry$4(this.this$0, this.$taskKey, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i != 0) {
            ...
            this.label = 1;
            if (UploadApi.DefaultImpls.retry$default(uploadApi, str, null, this, 2, null) == coroutine_suspended) {
