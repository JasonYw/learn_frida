...
@DebugMetadata(m136c = "cn.ever.cloud.sdk.api.DownloadApi$cancel$2", m135f = "DownloadApi.kt", m134i = {}, m133l = {55}, m132m = "invokeSuspend", m131n = {}, m130s = {})
/* loaded from: classes23.dex */
public final class DownloadApi$cancel$2 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public DownloadApi$cancel$2(DownloadApi downloadApi, String str, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        ...
        return new DownloadApi$cancel$2(this.this$0, this.$taskKey, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i != 0) {
            ...
            this.label = 1;
            if (downloadApi.cancel(str, this) == coroutine_suspended) {
