...
@DebugMetadata(m136c = "cn.ever.cloud.android.api.impl.AlbumApiImpl$modifyCover$2", m135f = "AlbumApiImpl.kt", m134i = {}, m133l = {BaseNotice.CREATOR}, m132m = "invokeSuspend", m131n = {}, m130s = {})
/* loaded from: classes23.dex */
public final class AlbumApiImpl$modifyCover$2 extends SuspendLambda implements Function1<Continuation<? super Boolean>, Object> {
    ...
    public AlbumApiImpl$modifyCover$2(AlbumApiImpl albumApiImpl, long j, String str, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        ...
        return new AlbumApiImpl$modifyCover$2(this.this$0, this.$albumId, this.$assetId, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i != 0) {
            ...
            this.label = 1;
            obj = albumService.modifyAlbumCover(j, str, this);
