...
@DebugMetadata(m136c = "cn.ever.cloud.sdk.api.AlbumApi$removeAssets$2", m135f = "AlbumApi.kt", m134i = {}, m133l = {133}, m132m = "invokeSuspend", m131n = {}, m130s = {})
/* loaded from: classes23.dex */
public final class AlbumApi$removeAssets$2 extends SuspendLambda implements Function1<Continuation<? super Boolean>, Object> {
    ...
    public AlbumApi$removeAssets$2(AlbumApi albumApi, long j, List list, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        ...
        return new AlbumApi$removeAssets$2(this.this$0, this.$albumId, this.$assetIds, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i != 0) {
            ...
            this.label = 1;
            obj = albumApi.removeAssets(j, list, this);
