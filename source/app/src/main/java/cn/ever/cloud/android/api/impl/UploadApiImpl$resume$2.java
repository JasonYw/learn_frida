...
@DebugMetadata(m136c = "cn.ever.cloud.android.api.impl.UploadApiImpl$resume$2", m135f = "UploadApiImpl.kt", m134i = {}, m133l = {127}, m132m = "invokeSuspend", m131n = {}, m130s = {})
/* loaded from: classes23.dex */
public final class UploadApiImpl$resume$2 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public UploadApiImpl$resume$2(UploadApiImpl uploadApiImpl, String str, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        ...
        return new UploadApiImpl$resume$2(this.this$0, this.$taskKey, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i != 0) {
            ...
            this.label = 1;
            if (taskService.resumeByGroupKey(i2, str, this) == coroutine_suspended) {
