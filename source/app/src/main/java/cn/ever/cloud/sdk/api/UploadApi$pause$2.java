...
@DebugMetadata(m136c = "cn.ever.cloud.sdk.api.UploadApi$pause$2", m135f = "UploadApi.kt", m134i = {}, m133l = {58}, m132m = "invokeSuspend", m131n = {}, m130s = {})
/* loaded from: classes23.dex */
public final class UploadApi$pause$2 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public UploadApi$pause$2(UploadApi uploadApi, String str, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        ...
        return new UploadApi$pause$2(this.this$0, this.$taskKey, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i != 0) {
            ...
            this.label = 1;
            if (uploadApi.pause(str, this) == coroutine_suspended) {
