...
@DebugMetadata(m136c = "cn.ever.cloud.sdk.api.UploadApi$resumeAll$2", m135f = "UploadApi.kt", m134i = {}, m133l = {115}, m132m = "invokeSuspend", m131n = {}, m130s = {})
/* loaded from: classes23.dex */
public final class UploadApi$resumeAll$2 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public UploadApi$resumeAll$2(UploadApi uploadApi, int i, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        ...
        return new UploadApi$resumeAll$2(this.this$0, this.$reason, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i != 0) {
            ...
            this.label = 1;
            if (uploadApi.resumeAll(boxInt, this) == coroutine_suspended) {
