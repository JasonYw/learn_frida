...
@DebugMetadata(m136c = "cn.ever.cloud.network.auth.SessionTokenProvider$getNewToken$3", m135f = "SessionTokenProvider.kt", m134i = {}, m133l = {BaseNotice.CREATOR}, m132m = "invokeSuspend", m131n = {}, m130s = {})
/* loaded from: classes23.dex */
public final class SessionTokenProvider$getNewToken$3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public SessionTokenProvider$getNewToken$3(SessionTokenProvider sessionTokenProvider, DependToken.SessionToken sessionToken, ClientError clientError, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        return new SessionTokenProvider$getNewToken$3(this.this$0, this.$sessionToken, this.$error, continuation);
    }
