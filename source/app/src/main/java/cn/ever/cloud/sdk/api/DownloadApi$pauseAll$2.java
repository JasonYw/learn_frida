...
@DebugMetadata(m136c = "cn.ever.cloud.sdk.api.DownloadApi$pauseAll$2", m135f = "DownloadApi.kt", m134i = {}, m133l = {65}, m132m = "invokeSuspend", m131n = {}, m130s = {})
/* loaded from: classes23.dex */
public final class DownloadApi$pauseAll$2 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public DownloadApi$pauseAll$2(DownloadApi downloadApi, int i, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        ...
        return new DownloadApi$pauseAll$2(this.this$0, this.$reason, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i != 0) {
            ...
            this.label = 1;
            if (downloadApi.pauseAll(boxInt, this) == coroutine_suspended) {
