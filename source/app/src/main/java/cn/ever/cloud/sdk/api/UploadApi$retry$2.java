...
@DebugMetadata(m136c = "cn.ever.cloud.sdk.api.UploadApi$retry$2", m135f = "UploadApi.kt", m134i = {}, m133l = {77}, m132m = "invokeSuspend", m131n = {}, m130s = {})
/* loaded from: classes23.dex */
public final class UploadApi$retry$2 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    public static ChangeQuickRedirect changeQuickRedirect;
    public final /* synthetic */ List $assetId;
    ...
    public UploadApi$retry$2(UploadApi uploadApi, String str, List list, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        ...
        return new UploadApi$retry$2(this.this$0, this.$taskKey, this.$assetId, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i != 0) {
            ...
            List<String> list = this.$assetId;
            this.label = 1;
            if (uploadApi.retry(str, list, this) == coroutine_suspended) {
