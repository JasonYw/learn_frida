...
@DebugMetadata(m136c = "cn.ever.cloud.android.api.impl.AlbumApiImpl$addAssetsPredefineAlbumId$2", m135f = "AlbumApiImpl.kt", m134i = {}, m133l = {91}, m132m = "invokeSuspend", m131n = {}, m130s = {})
/* loaded from: classes23.dex */
public final class AlbumApiImpl$addAssetsPredefineAlbumId$2 extends SuspendLambda implements Function1<Continuation<? super List<? extends String>>, Object> {
    ...
    public AlbumApiImpl$addAssetsPredefineAlbumId$2(AlbumApiImpl albumApiImpl, List list, long j, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        ...
        return new AlbumApiImpl$addAssetsPredefineAlbumId$2(this.this$0, this.$medias, this.$albumId, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i != 0) {
            ...
            long j = this.$albumId;
            this.label = 1;
            obj = albumService.addAssets(j, importUpsertChangeMedias, true, this);
