...
@DebugMetadata(m136c = "cn.ever.cloud.network.auth.SessionTokenProvider$getNewToken$2", m135f = "SessionTokenProvider.kt", m134i = {}, m133l = {55}, m132m = "invokeSuspend", m131n = {}, m130s = {})
/* loaded from: classes23.dex */
public final class SessionTokenProvider$getNewToken$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public SessionTokenProvider$getNewToken$2(SessionTokenProvider sessionTokenProvider, DependToken.SessionToken sessionToken, ClientError clientError, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        return new SessionTokenProvider$getNewToken$2(this.this$0, this.$sessionToken, this.$error, continuation);
    }
