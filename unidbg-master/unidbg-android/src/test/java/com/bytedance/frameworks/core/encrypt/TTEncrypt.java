...
public class TTEncrypt {
    ...
    TTEncrypt(boolean logging) {
        ...
        TTEncryptUtils = vm.resolveClass("com/bytedance/frameworks/core/encrypt/TTEncryptUtils"); //加载类的一个过程
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        Inspector.inspect(data, "ttEncrypt"); //unidbg提供的用来便捷的打印java数组的
    ...
    byte[] ttEncrypt() {
        ...
        //method是java中定义的名字 就是调用so native方法的名字 传参时必须使用unidbg包装后的类型
