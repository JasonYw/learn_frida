...
!function () {
  !function (t, e) {
    ...
    function q(t, e, n) {
      var r = e["$_CJa"],
        i = (e["$_DAK"], "GeetestError");
      return n && (i = "UserCallBackError", t["detail"] = n, r["error_code"] = "604", r["msg"] = t["msg"], c(j(r, "./usercallback/" + (t["detail"] && t["detail"]["type"])), r["post"], r["protocol"])), e["$_DB_"](t), new Error(i + ": " + (t && t["msg"]));
    }
    function F(t, e, n) {
      var r = e["$_CJa"];
    ...
    function j(t, e) {
      var n = "",
        r = 0;
      return t["$_DHT"] && (n = t["$_DHT"]["ip"], r = t["$_DHT"]["$_BCw"]), {
        "time": $_JJ(),
        "user_ip": n,
        "captcha_id": t["gt"],
    ...
    function _(t) {
      this["$_FIj"] = t, this["$_FJn"] = new lt(window), this["$_GAK"]();
    }
    _["prototype"] = {
      "$_GAK": function () {
        var $_HCGE = $_HCDC[0];
          ...
          a(function () {
            ...
            if (s(r)) {
              ...
              try {
                ...
                return u["$_JIU"](e), void o["$_JHN"](e);
              }
              _(o, t);
            } else n === o["RESOLVED"] ? o["$_JJU"](i) : n === o["REJECTED"] && o["$_JHN"](i);
          });
        },
        "then": function (n, r) {
          var $_BDFBu = $_BDEIY[0];
      ...
      "$_BBBR": function (t, e) {
        ...
        if (r) {
          for (var i = 0, o = r["length"]; i < o; i += 1) try {
            ...
            return z($("user_callback", n["$_BAIR"], s));
          }
          return n;
        }
      },
    ...
    function lt(t) {
      this["$_CGz"] = "string" == typeof t ? h["createElement"](t) : t;
    }
    function ft(t, e) {
      this["$_DCD"] = e, this["$_CGz"] = t;
    }
    ct["prototype"] = {
      "$_HBq": function (t) {
        var $_BFCGv = $_BFCDE[0];
      ...
      "$_GCP": function (t) {
        ...
        } else for (var r in e["$_BEGx"]) if (e["$_BEGx"][r] && 0 < e["$_BEGx"][r]["length"]) for (n = e["$_BEGx"][r]["length"] - 1; 0 <= n; n--) e["$_BEGx"][r][n]["$_BBCT"]();
        return e;
      },
      "$_BEHo": function (t) {
        var $_BHGGG = $_BHGDf[0];
      ...
      "$_BFBO": function (t) {
        ...
        if (t) {
          ...
          } else e = new lt(this["$_CGz"]["cloneNode"](!0));
          r["id"] = "origin_" + r["id"], e["$_BDFw"](["href"]);
        } else (e = new lt(this["$_CGz"]["cloneNode"](!1)))["$_BEAk"]("sandbox");
        return e;
      },
      "$_BFCn": function () {
        var $_BHJGA = $_BHJDF[0];
    ...
    function ee(t) {
      var e = this,
        n = t["$_CGz"];
      n["height"] = n["width"] = 0, e["$_BGIt"] = n["getContext"]("2d"), e["$_BGJG"] = e["$_BHAH"] = e["$_BHBP"] = e["$_BHCN"] = 0, e["$_BHDp"] = n;
    }
    function ne(t, e) {
      var n = this,
        r = new re(t);
    ...
    function ie(t) {
      var e = this,
        n = t["$_CJa"];
      e["$_BBHh"] = t["$_BBHh"], e["$_BAIR"] = t, e["$_CJa"] = n, e["$_DAK"] = t["$_DAK"], e["$_BHFl"] = t["$_BHFl"], e["$_BIAV"] = $_BGQ(e["$_CJa"]["i18n_labels"]), e["$"] = $_HW();
      var r = n["product"],
        i = ".holder." + n["theme"];
      w && (i += ".ie8"), "popup" === r ? e["$_BIBa"] = $_BIB(i + ".popup", $_BHV(Wt), e["$"]) : "float" === r ? e["$_BIBa"] = $_BIB(i + ".float", Wt, e["$"]) : "embed" === r && (e["$_BIBa"] = $_BIB(i + ".embed", Wt, e["$"])), e["$_GAK"]()["$_GBV"]();
    }
    function oe(t, e) {
      this["$_BICG"] = $_GL(), this["$_BIDw"] = !0, P["$_HAV"](this["$_BICG"], new ne(t, e));
    }
    function se(t, e, n, r, i) {
      var o = this;
      o["$_BIEt"] = r, o["$_BIFP"] = i, o["$_BJj"] = t, e = e["$_CGz"], x ? t["$_sTyyle"]({
        "filter": "progid:DXImageTransform.Microsoft.AlphaImageLoader(src=\"" + e["src"] + "\")"
      }) : t["$_sTyyle"]({
        "backgroundImage": "url(\"" + e["src"] + "\")"
      }), t["$_sTyyle"]({
        "left": $_BDD(o["$_BIEt"] / 260),
        "top": $_BDD(o["$_BIFP"]),
        "width": $_BDD(e["width"]),
        "height": $_BDD(e["height"])
      });
    }
    function ae(t) {
      var e = this,
        n = t["$_CJa"];
      n["mobile"] && "float" === n["product"] && (n["product"] = "embed"), e["$_BBHh"] = t["$_BBHh"], e["$_BAIR"] = t, e["$_CJa"] = n, e["$_DAK"] = t["$_DAK"], e["$_BHFl"] = t["$_BHFl"], e["$_BIAV"] = $_BGQ(e["$_CJa"]["i18n_labels"]), e["$"] = $_HW();
      var r = n["product"],
        i = ".holder.mobile." + n["theme"];
      "popup" === r || "custom" === n["product"] ? (n["template"] && "common" === n["template"] ? e["$_BIBa"] = $_BIB(i + ".popup", $_BHV(Qt), e["$"]) : e["$_BIBa"] = $_BIB(i + ".popup", $_BHV(Zt), e["$"]), n["width"] && e["$"](".popup_box")["$_sTyyle"]({
        "width": n["width"]
      }), n["bg_color"] && e["$"](".popup_ghost")["$_sTyyle"]({
        "backgroundColor": n["bg_color"]
      }), e["$_BIGQ"]()) : n["template"] && "common" === n["template"] ? e["$_BIBa"] = $_BIB(i + ".embed", Qt, e["$"]) : e["$_BIBa"] = $_BIB(i + ".embed", Zt, e["$"]), "embed" === n["product"] && e["$_DAK"]["isPC"] && e["$_DAK"]["$"] && (e["$_DAK"]["$"](".panel_ghost")["setStyles"]({
        "backgroundColor": n["bg_color"]
      }), e["$_BIGQ"]("embed")), n["is_next"] && e["$"](".result")["$_BEB_"]("absolute")["$_BEB_"]("fade"), e["$_BIHb"](), e["$_GAK"]()["$_GBV"]();
    }
    function $_DCD() {}
    function ce(t, e) {
      var n = this;
      n["$_BIIg"] = t(".result_icon"), n["$_BIJX"] = t(".result_title"), n["$_BJAY"] = t(".result_content"), n["$"] = t, n["$_BIAV"] = e;
    }
    function ue() {}
    ee["prototype"] = {
      "$_BJBX": function (t, e) {
      ...
      "$_CAFx": function (t) {
        ...
        E && n(".widget")["$_sTyyle"]({
          ...
          "paddingTop": 8 * (r["height"] - e["$_CFDK"]) / 44 + "%"
        });
        var i = t[0],
          o = t[1],
          s = t[2];
        if (Yt) try {
          i && $_BEG(i, n(".fullbg"), r["height"]), $_BEG(o, n(".bg"), r["height"]);
        } catch (a) {
          i && $_BFv(i, n(".fullbg"), r["height"]), $_BFv(o, n(".bg"), r["height"]);
        } else i && $_BFv(i, n(".fullbg"), r["height"]), $_BFv(o, n(".bg"), r["height"]);
      ...
      "$_CAFx": function (t) {
        var $_CHDBw = $_CHCIC[0];
        function a() {
          n(".canvas_img")["$_BDBV"](), n(".div_img")["$_BDCL"](), n(".fullbg", n(".div_fullbg")), n(".bg", n(".div_bg")), n(".slice", n(".div_slice")), i && $_BFv(i, n(".fullbg"), r["height"]), $_BFv(o, n(".bg"), r["height"]), e["$_BJj"] = new se(n(".slice"), s, r["height"], r["xpos"], r["ypos"]), "popup" === r["product"] || "custom" === r["product"] ? n(".popup_box")["$_sTyyle"]({
            "width": "$_FIj"
          }) : n(".holder")["$_sTyyle"]({
            "width": "$_FIj"
          }), n(".div_bg")["$_sTyyle"]({
            "height": $_BDD(r["height"])
        ...
        var e = this,
          ...
          r = e["$_CJa"];
        n(".window")["$_sTyyle"]({
          "paddingBottom": Number(r["height"] / e["$_CFGg"] * 100)["toFixed"](2) + "%"
        }), n(".loading")["$_sTyyle"]({
          "paddingTop": 10 * (r["height"] - e["$_CFDK"]) / 44 + "%"
        ...
        var i = t[0],
          ...
          s = t[2];
        if (Yt) try {
          n(".canvas_img")["$_BDCL"](), n(".div_img")["$_BDBV"](), n(".fullbg", n(".canvas_fullbg")), n(".bg", n(".canvas_bg")), n(".slice", n(".canvas_slice")), i && $_BEG(i, n(".fullbg"), r["height"]), $_BEG(o, n(".bg"), r["height"]), e["$_BJj"] = new ee(n(".slice"))["$_BJBX"](260, r["height"])["$_BJCj"](s, r["xpos"], r["ypos"]);
        } catch (_) {
          a();
        } else a();
      ...
      "$_CCHN": function (t) {
        ...
        var e = this["$"],
          n = this["$_CJa"],
          r = this["$_CFJA"] = t;
        return Q(t) && (r = $_BDD(t)), "popup" === n["product"] || "custom" === n["product"] || e(".holder")["$_sTyyle"]({
          "width": r
        }), this;
      }
    ...
    }, $_BAY(ae["prototype"], ue["prototype"] = {
      "$_CFGg": 260,
      "$_CGCc": 300,
      "$_CFDK": 116,
      "$_CEIn": 0,
      ...
      "$_CCIk": function () {
        ...
        var n = t["$"],
          r = t["$_BIAV"],
          i = parseInt(t["$_CJa"]["width"]);
        return n(".slider_tip")["$_BEJZ"](r["slide"]), n(".feedback_tip")["$_BEJZ"](r["feedback"]), n(".loading_tip")["$_BEJZ"](r["loading"]), n(".refresh")["$_CCg"]({
          "href": "javascript:;",
          "aria-label": "刷新验证",
          "role": "button",
          "tabIndex": "-1"
        }), "popup" === e["product"] || e["product"], e["feedback"] ? n(".feedback")["$_CCg"]({
          "target": "_blank",
          "href": e["feedback"]
        }) : n(".feedback")["$_BDBV"](), e["is_next"] ? (n(".refresh_tip")["$_BEJZ"](r["refresh"]), n(".refresh_1")["$_CCg"]({
          "href": "javascript:;",
          "aria-label": "刷新验证",
          "role": "button",
          "tabIndex": "-1"
          ...
          "role": "button",
          "tabIndex": "-1"
        }), n(".close_tip")["$_BEJZ"](r["close"]), i < 257 ? -1 != e["lang"]["toLowerCase"]()["indexOf"]("cn") || "zh" === e["lang"] ? n(".copyright_tip")["$_BEJZ"]("极验") : n(".copyright_tip")["$_BEJZ"]("Geetest") : n(".copyright_tip")["$_BEJZ"](r["logo"]), e["logo"] ? n(".copyright")["$_CCg"]({
          "target": "_blank",
          "href": e["homepage"]
        }) : n(".copyright")["$_BDBV"]()) : e["logo"] ? n(".logo")["$_CCg"]({
          "target": "_blank",
          "href": e["homepage"]
        }) : n(".logo")["$_BDBV"](), e["hideClose"] && n(".geetest_close")["$_DIX"](), e["hideRefresh"] && n(".geetest_refresh_1")["$_DIX"](), b && (n(".feedback_tip")["$_DIX"](), n(".refresh_tip")["$_DIX"](), n(".close_tip")["$_DIX"]()), e["link"] && n(".link")["$_CCg"]({
          "target": "_blank",
          "href": e["link"]
      ...
      "$_CId": function (t) {
        ...
        var e = this,
          n = e["$_CJa"];
        e["$"];
        if (e["$_CHBN"] = lt["$"](t), !e["$_CHBN"]) return z($("api_appendTo", e["$_BAIR"]));
      ...
      "$_CFIy": function () {
        ...
        function o() {
          var t = n(".wrap")["$_BFHJ"]();
          r === t && 0 !== r || 5 < i ? e["$_CHCY"]() : (i += 1, r = t, v(o, 100));
        }
        var e = this,
          n = e["$"],
          r = n(".wrap")["$_BFHJ"](),
      ...
      "$_CHCY": function () {
        ...
        -1 < new ct(["ar", "fa", "iw", "ur"])["$_BCHf"](t["lang"] && t["lang"]["split"]("-")[0]) && (e(".wrap")["$_sTyyle"]({
          "direction": "rtl"
      ...
      "$_CHDI": function () {
        ...
        t(".small")["$_CCg"]({
          ...
          "outline": "none"
        }), t(".voice_tip")["$_BEJZ"](n["voice"]), t(".close")["$_CCg"]({
          "tabIndex": "-1",
          "aria-label": n["close"],
          "role": "button"
        }), t(".refresh_1")["$_CCg"]({
      ...
      "$_CDJX": function (t, e, n) {
        ...
        var r = this,
          i = r["$_BBHh"];
        if (i["$_HBq"]() === It) {
          i["$_HAV"]($t), t["$_BGEn"](), r["$_CHIC"] = "pointerdown" == t["type"];
          var o = r["$"](".slider_button")["$_BEHo"](),
            s = r["$"](".canvas_slice")["$_BEHo"]();
          r["$_CHJu"] = $_Ii();
          var a,
            _,
            c = r["$_CFEk"];
          return r["$_CIAd"] = t["$_BGCd"]() / c, r["$_CIBf"] = t["$_BGDq"]() / c, _ = e ? (a = o["top"], o["left"]) : (a = s["top"] + r["$_BJj"]["$_BJFd"], s["left"]), r["$_CICM"] = new W([Math["round"](_ / c - r["$_CIAd"]), Math["round"](a / c - r["$_CIBf"]), 0])["$_BBDi"]([0, 0, 0]), r["$_BGJG"] = r["$_CEIn"], r["$_CFHm"]["$_GJN"](), r["lastPoint"] = {
            "x": 0,
            "y": 0
          }, $_Fw(n) && n(), r;
        }
      ...
      "$_BJIf": function (t) {
        ...
        if (e["$_BBHh"]["$_HBq"]() === $t && (!e["$_CHIC"] || "pointermove" == t["type"])) {
          ...
          var n = e["$_CFEk"],
            r = t["$_BGCd"]() / n - e["$_CIAd"],
            i = e["$_CIBf"] - t["$_BGDq"]() / n;
          e["$_BGJG"] = r, e["$_CICM"]["$_BBDi"]([Math["round"](r), Math["round"](i), $_Ii() - e["$_CHJu"]]), e["lastPoint"] && (e["lastPoint"]["x"] = r, e["lastPoint"]["y"] = i), r >= e["$_CGDw"] && e["$_CGIj"](t);
        }
      },
      "$_CGIj": function (t, e) {
        var $_DAABp = $_CJJId[0];
        ...
        try {
          ...
          }, 0), t["$_BGEn"](), i["$_HAV"]("lock");
          var a = n["$_CFEk"],
            _ = e ? n["lastPoint"]["x"] : t["$_BGCd"]() / a - n["$_CIAd"],
            c = e ? n["lastPoint"]["y"] : n["$_CIBf"] - t["$_BGDq"]() / a;
          n["$_CEDN"] = $_Ii() - n["$_CHJu"], n["$_CICM"]["$_BBDi"]([Math["round"](_), Math["round"](c), n["$_CEDN"]]);
          var u = parseInt(_),
            l = n["$_CICM"]["$_BBEM"](n["$_CICM"]["$_FDU"](), n["$_CJa"]["c"], n["$_CJa"]["s"]);
          r["$_CCBv"](u, l, n["$_CEDN"]), n["$_CFHm"]["$_GFd"]();
        } catch (t) {
          r["$_DB_"](t);
        }
        return n;
      ...
      "$_CBAa": function () {
        ...
        var e = this,
          ...
          r = e["$_CJa"],
          i = e["$_BBHh"];
        n(".loading")["$_BDCL"]()["$_BDDJ"](1), n(".fullbg")["$_BDDJ"](1)["$_BDCL"](), n(".slice")["$_BDDJ"](1), I(r, "/refresh.php", {
          "gt": r["gt"],
      ...
      "$_CEHh": function (t, e) {
        ...
        var s = 0.9 * r(".slider_button")["$_BFHJ"]();
        r(".progress_left") && r(".progress_left")["$_sTyyle"]({
          "width": t * n["$_CFEk"] + s + "px",
          "opacity": 1
