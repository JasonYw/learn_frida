...
function get_encode_trail(trail){
    return W["prototype"]["$_FDU"](trail)
}
function get_encode_trail_with_c_s(encode_trail,c,s){
    return W["prototype"]["$_BBEM"](encode_trail, c, s)
}
function get_userresponse(distance,challenge){
    return H(distance, challenge)
}
function get_rp(gt,challenge,passtime) {
    return X(gt + challenge["slice"](0, 32) + passtime)
}
function get_l(o){
    return V["encrypt"](gt["stringify"](o), ne["prototype"]["$_CCEc"]())
}
function get_u(){
...
function get_w(gt,challenge,distance,passtime,trail_list,c,s,tm){
    var o = {
        "lang": "zh-cn",
        "userresponse": get_userresponse(distance, challenge),
        "passtime": passtime,
        "imgload": 230, 
        "aa": get_encode_trail_with_c_s(get_encode_trail(trail_list), c, s),
...
// console.log(get_rp("019924a82c70bb123aae90d483087f94","7846d86c20bed97fc8d51b46cdfc45e8ei",211))