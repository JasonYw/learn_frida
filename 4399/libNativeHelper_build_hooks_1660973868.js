...
function hook_so_func(addr,paramsnum,relativePtr){
    Interceptor.attach(addr,{
        ...
        onLeave:function(retval){
            ...
            console.log("base:",addr.toString(16),"relativePtr:",relativePtr.toString(16),"====>")
