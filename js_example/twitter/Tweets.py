...
class Tweets:
    def __init__(self, user_id: int = 44196397,user_name : str = "elonmusk") -> None:
        query_id = getApiQueryId("UserTweets")
        base_url = f"https://twitter.com/i/api/graphql/{query_id}/UserTweets"
        variables = {"userId": str(user_id), "count": 40, "includePromotedContent": True, "withQuickPromoteEligibilityTweetFields": True,
    ...
    def crawl(self):
        ...
        open('test1.json', 'wb').write(res.content)
        print(res.text)
