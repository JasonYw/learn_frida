...
function hook_suspected_function(targetSo) {
    const funcs = [['Java_com_peopledaily_common_store_db_entity_StasticEntity_toString__', '函数Java_com_peopledaily_common_store_db_entity_StasticEntity_toString__疑似哈希函数运算部分。', '0x89fd4'], ['Java_com_peopledaily_common_bean_UserInfoBean_toString__', '函数Java_com_peopledaily_common_bean_UserInfoBean_toString__疑似哈希函数运算部分。', '0x9c00c'], ['Java_com_peopledaily_common_bean_SettingBean_toString__', '函数Java_com_peopledaily_common_bean_SettingBean_toString__疑似哈希函数运算部分。', '0x9f1f0'], ['Java_com_peopledaily_common_bean_SmallVideoInfo_toString__', '函数Java_com_peopledaily_common_bean_SmallVideoInfo_toString__疑似哈希函数运算部分。', '0xa5b40'], ['Java_com_peopledaily_common_statistics_v2_StatisticsAscription_ascription__Lcom_peopledaily_common_statistics_v2_record_IDataProvide_2', '函数Java_com_peopledaily_common_statistics_v2_StatisticsAscription_ascription__Lcom_peopledaily_common_statistics_v2_record_IDataProvide_2疑似哈希函数运算部分。', '0xae8d0'], ['sub_E7A18', '函数sub_E7A18疑似哈希函数运算部分。', '0xe7a18'], ['sub_EBDC0', '函数sub_EBDC0疑似哈希函数运算部分。', '0xebdc0'], ['sub_F0218', '函数sub_F0218疑似哈希函数运算部分。', '0xf0218']];
    for (var i in funcs) {
...
function main() {
    var targetSo = Module.findBaseAddress('libcom.peopledailychina.activity_alijtca_plus.so');
