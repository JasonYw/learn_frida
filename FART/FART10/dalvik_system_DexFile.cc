...
extern "C" void xiaojianbangFunctionInvoke(ArtMethod* artMethod);
// add
...
static void DexFile_saveMethodCodeItem(JNIEnv* env, jclass, jobject method) {
  if(method != nullptr) {
    ...
    xiaojianbangFunctionInvoke(proxyMethod);
  }
}
// add
...
static JNINativeMethod gMethods[] = {
  ...
  NATIVE_METHOD(DexFile, saveMethodCodeItem, "(Ljava/lang/Object;)V")
};
